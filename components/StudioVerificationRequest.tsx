      ...
      <View style={[styles.container, styles.statusCard]}>
        <View style={[styles.statusBanner, { backgroundColor: "rgba(245, 158, 11, 0.1)" }]}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.statusDesc}>
              Your verification request is being reviewed. You'll be notified
              once it's processed.
            </Text>
          </View>
        </View>
  ...
  return (
    <View style={styles.container}>
      {status === "REJECTED" && verification?.notes && (
        <View style={[styles.statusBanner, { backgroundColor: "rgba(239, 68, 68, 0.1)", marginBottom: 16 }]}>
      ...
      <TouchableOpacity
        style={[
          styles.submitBtn,
          documents.length === 0 && { opacity: 0.5 },
        ]}
